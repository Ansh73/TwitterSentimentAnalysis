...
import streaming.TwitterProducer.Sentiment.Sentiment
...
*/
    ...
    //println("The data in tweet is " + tweetData)
    ...
    //Sentiment Analysis on tweets:
      ...
      def extractSentiment(text: String): Sentiment = {
        ...
        //println("Anshul returning sentiment" + sentiment)
        sentiment
      }
      ...
      def extractSentiments(text: String): List[(String, Sentiment)] = {
        ...
        //println("Anshul Initialized pipeline ")

        val annotation: Annotation = pipeline.process(text)
        //println("Anshul processed text")
        ...
        sentences
          ...
          .toList
        //println("Anshul processed sentences")
      }
